...
export default function TokenPoolInfo() {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 my-6 sm:my-8 animate-fade-in">
      <div className="relative overflow-hidden rounded-2xl border border-green-500/30 bg-green-900/10 backdrop-blur-lg shadow-xl p-6 sm:p-8 transition-all duration-300 hover:shadow-green-300/20 group">

        {/* Glowing Background Blobs */}
        <div className="absolute -top-12 -left-12 w-40 h-40 bg-green-400 opacity-20 rounded-full blur-2xl z-0 animate-blob group-hover:opacity-30"></div>
        <div className="absolute -bottom-12 -right-12 w-40 h-40 bg-green-500 opacity-20 rounded-full blur-2xl z-0 animate-blob animation-delay-2000 group-hover:opacity-30"></div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center">
          {loading ? (
            ...
            <>
              ...
              <h3 className="text-4xl sm:text-5xl font-extrabold text-white drop-shadow-sm animate-pulse">
